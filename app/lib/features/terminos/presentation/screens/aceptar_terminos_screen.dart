...
class AceptarTerminosScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AceptarTerminosScreen> createState() =>
      _AceptarTerminosScreenState();
}
...
class _AceptarTerminosScreenState extends ConsumerState<AceptarTerminosScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.l10n.terminosTitulo),
                    ...
                    children: [
                      for (final termino in pendientes) ...[
                        ...
                        CheckboxListTile(
                          ...
                          title: Text(
                            context.l10n.terminosHeAceptado(termino.titulo),
                          ),
                          onChanged: (marcado) {
                            setState(() {
                              if (marcado ?? false) {
