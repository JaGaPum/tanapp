...
final clienteTiposListProvider = FutureProvider.autoDispose<List<ClienteTipo>>((
  ref,
) {
  return ref.watch(clienteTiposRepositoryProvider).listClienteTipos();
});

final clienteTipoDetailProvider = FutureProvider.autoDispose
    .family<ClienteTipo, String>((ref, id) {
