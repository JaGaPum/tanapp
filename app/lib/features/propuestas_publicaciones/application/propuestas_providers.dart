...
final propuestasPendientesProvider =
    FutureProvider.autoDispose<List<PublicacionPropuesta>>((ref) {
...
final propuestasPendientesCountProvider = Provider.autoDispose<int>((ref) {
  return ref
      .watch(propuestasPendientesProvider)
      .maybeWhen(data: (lista) => lista.length, orElse: () => 0);
});
