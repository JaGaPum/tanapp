...
final comunicacionesListProvider =
    FutureProvider.autoDispose<List<Comunicacion>>((ref) {
      return ref.watch(comunicacionesRepositoryProvider).listComunicaciones();
    });

final comunicacionDetailProvider = FutureProvider.autoDispose
    .family<Comunicacion, String>((ref, id) {
